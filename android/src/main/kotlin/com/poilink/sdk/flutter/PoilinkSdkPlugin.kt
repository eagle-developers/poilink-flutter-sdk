...
class PoilinkSdkPlugin : FlutterPlugin, ActivityAware, PoilinkHostApi {
  ...
  private fun buildWebPortalOptions(msg: WebPortalOptionsMsg): PoilinkSDK.WebPortalOptions {
    ...
    opts.onRewardReceive = PoilinkSDK.RewardReceiveCallback { grantId, itemCode, quantity, missionCode ->
      runOnMain { eventApi?.onRewardReceive(handle, grantId, itemCode, quantity.toLong(), missionCode) { } }
    }
    return opts
  }
